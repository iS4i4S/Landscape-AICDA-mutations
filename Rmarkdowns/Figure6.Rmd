...
```{r panel6A_cals,echo=T,eval=F,fig.show="hide"}
##Import data
...
```{r panel6A_cals2,echo=T,eval=F,fig.show="hide"}
######
...
```{r panel_6A, fig.width=20,fig.height=18,fig.show=F}
##Import data
data_dir<-"/media/user/seagate_ICM/AICDA_analysis/Github_repository/" #Set to where you downloaded the data
setwd(data_dir)
source("r/prerequisites.R")
...
```{r panel_6A2, fig.width=18,fig.height=10.5,fig.show=T}
p_neoAgs2
```
...
```{r panel6B_cals,echo=T,eval=F,fig.show="hide"}
##Import data
data_dir<-"/media/user/seagate_ICM/AICDA_analysis/Github_repository/" #Set to where you downloaded the data
setwd(data_dir)
source("r/prerequisites.R")
...
```{r panel_6B, fig.width=20,fig.height=18}
##Import data
data_dir<-"/media/user/seagate_ICM/AICDA_analysis/Github_repository/" #Set to where you downloaded the data
setwd(data_dir)
source("r/prerequisites.R")
...
```{r panel6C_cals,echo=T,eval=F,fig.show="hide"}
##Import data
data_dir<-"/media/user/seagate_ICM/AICDA_analysis/Github_repository/" #Set to where you downloaded the data
setwd(data_dir)
source("r/prerequisites.R")
...
```{r panel_6C, fig.width=20,fig.height=10}
##Import data
data_dir<-"/media/user/seagate_ICM/AICDA_analysis/Github_repository/" #Set to where you downloaded the data
setwd(data_dir)
source("r/prerequisites.R")
...
```{r panel6D_cals,echo=T,eval=F,fig.show="hide"}
##Import data
data_dir<-"/media/user/seagate_ICM/AICDA_analysis/Github_repository/" #Set to where you downloaded the data
setwd(data_dir)
source("r/prerequisites.R")
...
```{r panel_6D, fig.width=20,fig.height=18}
##Import data
data_dir<-"/media/user/seagate_ICM/AICDA_analysis/Github_repository/" #Set to where you downloaded the data
setwd(data_dir)
source("r/prerequisites.R")
...
```{r panel6E_cals,echo=T,eval=F,fig.show="hide"}
##Import data
data_dir<-"/media/user/seagate_ICM/AICDA_analysis/Github_repository/" #Set to where you downloaded the data
setwd(data_dir)
source("r/prerequisites.R")
...
```{r panel_6E, fig.width=20,fig.height=18}
##Import data
data_dir<-"/media/user/seagate_ICM/AICDA_analysis/Github_repository/" #Set to where you downloaded the data
setwd(data_dir)
source("r/prerequisites.R")
...
```{r panel6F_cals,echo=T,eval=F,fig.show="hide"}
##Import data
data_dir<-"/media/user/seagate_ICM/AICDA_analysis/Github_repository/" #Set to where you downloaded the data
setwd(data_dir)
source("r/prerequisites.R")
...
```{r panel_6F, fig.width=18,fig.height=12}
##Import data
data_dir<-"/media/user/seagate_ICM/AICDA_analysis/Github_repository/" #Set to where you downloaded the data
setwd(data_dir)
source("r/prerequisites.R")

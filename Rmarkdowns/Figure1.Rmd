...
```{r calculations_fig1a,echo=F,eval=F}
library(tidyr)
library(ggplot2)
library(reshape2)
library(dplyr)
...
#Load functions:
load("/media/user/seagate_ICM/AICDA_analysis/ICGC/APOBEC_enrich_function_WES_WGS.RData") ##Change where you downloaded the functions...
load("/media/user/seagate_ICM/AICDA_analysis/ICGC/AICDA_enrich_function_WES_WGS.RData") ##Change where you downloaded the functions...
...
```{r calculations_Supfig1a,echo=F,eval=F}
library(Palimpsest)
library(maftools)
